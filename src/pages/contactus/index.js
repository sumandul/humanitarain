      ...
      <section className="flex justify-center contact text-white py-14">
        <div className="text-center">
          ...
          <p className="uppercase font-bold text-2xl tracking-wider mt-6">
            ...
            <br></br>We're here to assist you on your career journey.
          </p>
          <div className="flex gap-8 items-center mt-8"></div>
        </div>
      </section>
        ...
        <div className="flex justify-around">
          <div className="bg-white w-[40%] rounded-2xl p-8">
            ...
            <form className=" mt-8">
              <input
                type="text"
                placeholder="Name"
                className="p-3 rounded-xl border-[1px] border-white bg-[#F8FAFC] w-full"
              />
              <input
                type="email"
                placeholder="Email"
                className="p-3 rounded-xl border-[1px] border-white bg-[#F8FAFC] w-full mt-2"
              />
              <input
                type="phone"
                placeholder="Phone"
              ...
              <textarea
                type="text"
                placeholder="Message"
                className="p-3 rounded-xl border-[1px] border-white bg-[#F8FAFC] mt-2 w-full"
              />
              <Button
                text={"Send Message"}
                icon={false}
                className={
                  "bg-human-green py-2 w-full text-white rounded-xl font-semibold text-xl mt-4"
                }
              />
            </form>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 h-max">
            ...
            <p className="text-xl font-light">
              Bansbari Rd, Kathmandu 44600, Nepal
            </p>
            <div className="mt-8">
