  ...
  return (
    <main className={openSans.className}>
      <section className="hero h-[80vh]">
        <div
          className={`h-[50%] bg-black/40 text-white text-center py-12 px-16`}
        >
          <h1 className="font-bold text-6xl leading-[70px]">
            Humanitarian Manpower Service
          </h1>
          <p className="uppercase font-bold text-2xl tracking-wider mt-6">
            we are a leading recruitment and outsourcing agency based in nepal
          </p>
          <div
            className={`${roboto.className} text-2xl font-bold mt-12 flex gap-8 justify-center items-center`}
          >
            <Button
              className={"bg-human-green rounded-3xl py-3 px-9"}
              text={"View Current Openings"}
              icon={true}
            />
            <Button
              className={"border-2 border-white rounded-3xl py-2 px-9"}
      ...
      <section className="mt-16 px-24  flex justify-center">
        <div className="max-w-[1440px] ">
          ...
          <div className="grid grid-cols-[1fr_35px_1fr] gap-10 mt-14">
            <div className="bg-[#F8FAFC] rounded-3xl py-8 px-10 max-w-[592px]">
              <div className="rounded-xl">
                ...
                <p className="text-xl mt-6">
                  Our dedicated team is committed to guiding you through each
                  step, ensuring a smooth experience.
                </p>
                <div
                  className={`${roboto.className} text-xl text-white font-bold mt-12 flex gap-8 justify-end items-center`}
                >
                  <Button
                    className={"bg-human-green rounded-3xl py-3 px-9"}
                    text={"View Current Openings"}
            ...
            <div className="bg-human-green rounded-3xl w-[35px] h-[6px] place-self-center"></div>
            <div className="bg-[#F8FAFC] rounded-3xl py-8 px-10 max-w-[592px]">
              <div className="rounded-xl">
                <Image src={services2} alt="services" />
                <h2 className="text-3xl font-bold mt-6">Client Recruitment</h2>
                <p className="text-xl mt-6">
                  We specialize in unlocking your company's full potential by
                  connecting you with top-tier talent.
                </p>
                <div
                  className={`${roboto.className} text-xl text-white font-bold mt-12 flex gap-8 justify-end items-center`}
                >
      ...
      <section className="mt-16 px-24 flex justify-center">
        <div className="max-w-[1440px]">
          ...
          <div className="grid grid-cols-[1fr_33px_1fr_33px_1fr] gap-10 mt-14 ">
            <WorkProcessCard
              img={workprocess}
              heading={"View Open Positions"}
              icon={globesearch}
              para={
                "Browse through diverse roles that align with your skills, experience, and career aspirations."
              }
            />
            ...
            <WorkProcessCard
              ...
              icon={cv}
              para={
                "Once you've identified the role that resonates with your career goals, submit your application."
              }
            />
            <div className="bg-[#2DD4BF] rounded-3xl w-[35px] h-[6px] place-self-center"></div>
            <WorkProcessCard
              ...
              icon={appreview}
              para={
                "Our dedicated recruitment team will carefully review your CV and take decision."
              }
            />
          </div>
        </div>
      ...
      <section className="text-center mt-16 py-10">
        ...
        <p className="text-lg font-semibold mt-8">
          Subscribe to our newsletter to get update on new Vacancies.
        </p>
        ...
        <div className="flex justify-center mt-8">
          <Button
            ...
            text={"Subscribe"}
            className={
              "bg-[#047857] rounded-lg py-2 px-7 text-white text-xl font-semibold"
            }
          />
        </div>
      </section>
