    ...
    return (
        <>
            ...
            <main className="px-6 sm:px-20 mb-14">
                <section className="mt-10">
                    ...
                    <div className="flex justify-between items-start">
                        <div>
                            ...
                            <button className="text-[#5374E7] text-sm bg-[#5374E71A] py-1 px-4 rounded-2xl mt-3">{show.numofApp}+ Applicants </button>

                        </div>

                        <button ><i className="bi bi-bookmark text-lg text-[#475569]"></i></button>
                ...
                <h2 className="font-bold mt-4 underline text-[#475569]">Key Requirements</h2>
                <ul className="ml-7">
                    {
                        show.requirements?.map((data,index) => {return <li key={index} className="list-disc">{data}</li>})
                    }
                </ul>

                <p className="font-bold text-[#475569] mt-6">CANDIDATES THAT DO NOT MEET THE KEY REQUIREMENTS WILL NOT BE CONSIDERED</p>
                </section>
